        ...
        >
          ...
          {PRODUCTS.map((product, idx) => {
            ...
            return (
              ...
              >
                <div>
                  <div className="relative aspect-[3/4] overflow-hidden bg-[#1a1514] rounded-xs mb-6 border border-white/10 group/img flex items-center justify-center">
                    <img
                      src={product.images[0]}
                      alt={product.alt}
                      loading="lazy"
                      className="h-full w-full object-contain p-3 transition-transform duration-700 group-hover/card:scale-105"
                    />
